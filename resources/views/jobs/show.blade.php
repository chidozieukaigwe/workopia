                ...
                @auth
                    ...
                    <div x-data="{open: false}">
                        ...
                        <div x-show="open" class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
                            <div class="bg-white p-6 rounded-lg shadow-md w-full max-w-md" @click.away="open = false">
                                ...
                                <form method="POST" action="{{ route('applicant.store', $job->id) }}"
                                    ...
                                    <button class="bg-gray-300 hover:bg-gray-400 text-white px-4 py-2 rounded-md"
                                        @click="open = false">
                                        Cancel
                                    </button>
                                </form>
