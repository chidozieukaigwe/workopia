<x-layout>
    ...
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
        ...
        <form method="POST" action="{{ route('jobs.update', $job->id) }}" enctype="multipart/form-data">
            ...
            <x-inputs.text id="title" name="title" label="Job Title" placeholder="Senior Software Developer"
                :value="old('title', $job->title)" />


            <x-inputs.text-area id="description" name="description" label="Description"
                placeholder="Job description goes here..." :value="old('description', $job->description)" />
